...
<body>
    ...
    <main>
        <h1>Aportaciones</h1>
        <p>Este este apartado se podra subir y ver  diferentes tipos de casos de cosas o adegnotas que les haiga pasado a alguna persona, ademas de tambien de poder subir  links de videos para una mejor retroalimentacion</p>
